...
export const HABITS_BY_CATEGORY = {
  [HABIT_CATEGORIES.MORNING]: [
    HABITS.LEGS_UP_WALL,
    HABITS.DRY_BRUSHING,
    HABITS.CONTRAST_SHOWER,
    HABITS.MORNING_HYDRATION,
  ],
  [HABIT_CATEGORIES.DAYTIME]: [
    HABITS.HOURLY_MOVEMENT,
    HABITS.STEPS_COUNT,
    HABITS.DAILY_HYDRATION,
  ],
  [HABIT_CATEGORIES.EVENING]: [
    HABITS.GLUTE_EXERCISES,
    HABITS.TOE_PICKUPS,
    HABITS.OIL_MASSAGE,
    HABITS.MAGNESIUM_APP,
    HABITS.LEGS_ELEVATED,
  ],
  [HABIT_CATEGORIES.NUTRITION]: [
    HABITS.COLLAGEN_INTAKE,
    HABITS.PROTEIN_MEALS,
    HABITS.LOW_SUGAR,
    HABITS.AVOID_SEED_OILS,
  ],
};
